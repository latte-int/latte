...
# INPUT : W:=a list of   p-vectors w_i of length r (with rational entries), Lambda a list of p-vectors alpha_i of length r (with rational entries). 
...
myChoose:=proc(inputList, k)
	...
	#use the maple choose function if there are not many unique numbers.
