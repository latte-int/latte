...
void computeResidue(int d, int M, const vec_RationalNTL &innerProDiff, const RationalNTL &p, RationalNTL &finalAnswer);//compute residue given the inner products
